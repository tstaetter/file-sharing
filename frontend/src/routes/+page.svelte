<script lang="ts">
	...
	async function upload() {
		...
		try {
			...
			link = await createCapabilityUrl('http://127.0.0.1:5173', fileId, raw);
		} finally {
			uploading = false;
		}
	}
...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center p-4">
	<div class="w-full max-w-lg">
		...
		<div class="bg-white rounded-2xl shadow-lg shadow-slate-200/50 border border-slate-100 p-8">
			<!-- Icon -->
			<div class="mx-auto w-14 h-14 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center mb-6 shadow-md shadow-blue-200/50">
			...
			<!-- Title -->
			<h1 class="text-2xl font-semibold text-slate-800 text-center mb-2">
			...
			{#if link}
				<div class="mt-6 p-4 bg-green-50 border border-green-200 rounded-xl">
					<p class="text-xs font-medium text-green-700 mb-2 uppercase tracking-wide">Share this link</p>
